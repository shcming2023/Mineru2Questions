...
**题目**: 10. 求出括号内的代数式，使等式成立： (1) ( ) - 2√32 - (4√18 - √18) = -3√2;
...
**题目**: 13. 与  $\sqrt{12a}$  是同类二次根式的是（ ）. A.  $\sqrt{\frac{3}{ab}}$
...
**题目**: 14. 下列二次根式是同类二次根式的是（ ）. A.  $\sqrt{0.36}$  和  $2\sqrt{0.6}$
...
**题目**: 15. 下列说法正确的是( ). A. 同类二次根式一定是最简二次根式
...
**题目**: 16. 下列计算正确的是( ). A.  $3 + \sqrt{2} = 3\sqrt{2}$
...
**题目**: 17. 在下列各组二次根式中，不可以合并的是（ ）. A.  $\sqrt{45}$  和  $\sqrt{20}$

---

### 36 (练习题)

**题目**: B.  $\frac{1}{3}\sqrt{8}$  和  $\frac{1}{5}\sqrt{\frac{1}{2}}$

---

### 37 (练习题)

**题目**: C.  $\sqrt{12}$  和  $\sqrt{18}$

---

### 38 (练习题)

**题目**: D.  $\sqrt{24}$  和  $\sqrt{54}$
...
**题目**: (1) 解不等式:  $3x - \frac{\sqrt{27}}{2} < 6x + \sqrt{54}$ ;

---

### 13(2) (练习题)

**题目**: (2）解方程组：  $\begin{cases} 3x - y = \sqrt{\frac{2}{3}},\\ x + 3y = \sqrt{96}. \end{cases}$

---

### 14(1) (练习题)

**题目**: (1) 解方程:  $\sqrt{15} x = \sqrt{3\frac{3}{8}} \times (-\sqrt{20})$ ;

---

### 14(2) (练习题)

**题目**: （2）解不等式：  $\sqrt{5} x > 3\sqrt{5} x - 6\sqrt{3}$
...
**题目**: 1. 不等式  $x < \sqrt{3} x + 4$  的解集是

---

### 2 (练习题)

**题目**: 2. 计算：(1)  $\frac{2}{3}\sqrt{9a} + 6\sqrt{\frac{a}{4}} - 2a\sqrt{\frac{1}{a}} = \_$ ；(2)  $\frac{1}{4}\sqrt{18} \times 8\sqrt{\frac{1}{36}} \div \frac{2}{3}\sqrt{4\frac{1}{2}} = \_$ .

---

### 3 (练习题)

**题目**: 3. 分母有理化：(1)  $\frac{\sqrt{2}}{3\sqrt{2} + 2\sqrt{3}} = \_$ ；(2)  $\frac{a - 2\sqrt{ab} + b}{b\sqrt{a} - a\sqrt{b}} = \_$ .

---

### 4 (练习题)

**题目**: 4. 计算:  $\sqrt{7 + \sqrt{48}} - \sqrt{7 - \sqrt{48}} = \_$

---

### 5 (练习题)

**题目**: 5. 方程组  $\left\{ \begin{array}{l} \sqrt{3} x - \sqrt{2} y = 4, \\ x - y = \sqrt{2} \end{array} \right.$  的解是

---

### 6 (练习题)

**题目**: 6. 已知  $\sqrt{7}$  的整数部分等于  $a$ ，小数部分等于  $b$ ，则  $3\left(a + \frac{1}{b}\right)$  的值等于 ______.

---

### 6(5) (练习题)

**题目**: (5)  $\left(\sqrt{18} - 4\sqrt{\frac{1}{2}} + \frac{1}{\sqrt{3} - \sqrt{2}}\right) \div \frac{\sqrt{3}}{3} - \sqrt{18} \div (\sqrt{3} + \sqrt{2})$ ;
...
**题目**: (1)  $\sqrt{0.5} + \sqrt{32} - 2\sqrt{\frac{1}{3}} - \sqrt{\frac{1}{8}} - \sqrt{75}$ ;

---

### 7(2) (练习题)

**题目**: (2)  $2\sqrt{25a} - 3\sqrt{a^2b} + 5\sqrt{36a} - 2\sqrt{a^2b}$ ;

---

### 7(3) (练习题)

**题目**: (3)  $(8\sqrt{21} \div \sqrt{15}) \times (\sqrt{12} \div 5\sqrt{6})$

---

### 7(4) (练习题)

**题目**: (4)  $3\sqrt{\frac{12}{x}} \cdot \frac{1}{2}\sqrt{\frac{3}{xy}} \div \left(-\frac{3}{4}\sqrt{\frac{18}{xy^3}}\right)$ ;

---

### 7(6) (练习题)

**题目**: (6)  $\frac{\sqrt{6} + 4\sqrt{3} + 3\sqrt{2}}{(\sqrt{6} + \sqrt{3})(\sqrt{3} + \sqrt{2})}$ ;

---

### 7(7) (练习题)

**题目**: (7)  $\frac{\sqrt{10} + \sqrt{14} - \sqrt{15} - \sqrt{21}}{\sqrt{10} + \sqrt{14} + \sqrt{15} + \sqrt{21}}$ ;

---

### 7(8) (练习题)

**题目**: (8)  $\frac{1}{3 + \sqrt{3}} + \frac{1}{5\sqrt{3} + 3\sqrt{5}} + \frac{1}{7\sqrt{5} + 5\sqrt{7}} + \dots + \frac{1}{49\sqrt{47} + 47\sqrt{49}}.$

---

### 8 (练习题)

**题目**: 8. 已知  $y = \sqrt{x - \frac{1}{2}} + \sqrt{\frac{1}{2} - x} + 8$ ，求  $\frac{x - 4y}{\sqrt{x} - 2\sqrt{y}} - \frac{x + y + 2\sqrt{xy}}{x + \sqrt{xy}} \div \left(\frac{1}{\sqrt{x}} + \frac{1}{\sqrt{y}}\right)$  的值.

---

### 9 (练习题)

**题目**: 9. 设  $M = \frac{1}{1 + \sqrt{2}} + \frac{1}{\sqrt{2} + \sqrt{3}} + \frac{1}{\sqrt{3} + \sqrt{4}} + \dots + \frac{1}{\sqrt{2025} + \sqrt{2026}}$ ，且  $N = 1 - 2 + 3 - 4 + 5 - 6 + \dots + 2025 - 2026$ ，求  $\frac{N}{(M + 1)^2}$  的值.

---

### 10 (练习题)

**题目**: 10. 已知  $(\sqrt{1 + a^2} + a)(\sqrt{1 + b^2} + b) = 1$ ，试求  $a, b$  之间的(简单)关系式

---

### 11 (练习题)

**题目**: 11. 已知  $x = \frac{1}{\sqrt{2} + 1}, y = \frac{1}{\sqrt{2} - 1}$ , 求下列各式的值:
...
**题目**: (2)  $-\frac{1}{3}\sqrt{60} \div \frac{3}{4}\sqrt{\frac{125}{2}} =$

---

### 12(3) (练习题)

**题目**: (3)  $\left(\sqrt{\frac{x}{y}} -\sqrt{\frac{y}{x}}\right)\div \left(\frac{1}{\sqrt{y}} -\frac{1}{\sqrt{x}}\right) =$

---

### 12(4) (练习题)

**题目**: (4)  $\frac{14}{st}\sqrt{\frac{6}{st^2}}\cdot \sqrt{\frac{5s^3}{12t}} = \underline{\quad}$
...
**题目**: (2)  $2\sqrt{4 + 2\sqrt{3}} - \sqrt{21 - 12\sqrt{3}} =$  ______.
...
**题目**: 19. 如果  $m \geqslant 0, n < 0$ , 那么化简  $-\sqrt{mn^2}$  的结果为( ). A.  $-n\sqrt{m}$ B.  $n \sqrt{m}$ C.  $- n\sqrt{-m}$ D.  $n \sqrt{-m}$

---

### 20 (练习题)

**题目**: 20. 某同学做了以下四题，其中做错的有（ ）. ①  $\sqrt{16a^4} = 4a^2$ ; ②  $\sqrt{5a} \cdot \sqrt{10a} = 5a\sqrt{2}$ ; ③  $a\sqrt{\frac{1}{a}} = \sqrt{a^2 \cdot \frac{1}{a}} = \sqrt{a}$ ; ④  $\sqrt{3a} - \sqrt{2a} = \sqrt{a}$ . A. 1 个 B. 2 个 C. 3 个 D. 4 个
...
**题目**: (1)  $\sqrt{\frac{45}{4}} -\sqrt{20} -5\sqrt{\frac{1}{18}} -\frac{1}{6}\sqrt{245} -\sqrt{\frac{49}{2}};$

---

### 21(2) (练习题)

**题目**: (2)  $8x^{2}\sqrt{xy} \div 12\sqrt{\frac{x^{3}}{y}} \times 3\sqrt{\frac{y^{2}}{x}}$ ;

---

### 21(3) (练习题)

**题目**: (3)  $\sqrt{24} - \sqrt{0.5} - 2\sqrt{\frac{2}{3}} - \left(\sqrt{\frac{1}{8}} - \frac{1}{3}\sqrt{54}\right)$ ;

---

### 21(4) (练习题)

**题目**: (4)  $\left(-\frac{2}{3}\sqrt{3.75}\right)\times \frac{3}{4}\left[\sqrt{2.4}\times \left(-\frac{6}{5}\sqrt{2\frac{2}{3}}\right)\right]$

---

### 21(5) (练习题)

**题目**: (5)  $\frac{2\sqrt{3} + 3\sqrt{2}}{2\sqrt{3} - 3\sqrt{2}} - \frac{2\sqrt{3} - 3\sqrt{2}}{2\sqrt{3} + 3\sqrt{2}}$ ;

---

### 21(6) (练习题)

**题目**: (6)  $-\sqrt{6} \div \left(\frac{1}{\sqrt{2}} - \frac{1}{\sqrt{3}}\right)$ .
...
**题目**: 24. 化简:  $\left(\sqrt{a} + \frac{b - \sqrt{ab}}{\sqrt{a} + \sqrt{b}}\right) \div \left(\frac{a}{\sqrt{ab} + b} + \frac{b}{\sqrt{ab} - a} - \frac{a + b}{\sqrt{ab}}\right)$ .

---

### 25 (练习题)

**题目**: 25. 先化简, 再求值:  $\left(\frac{x + 2\sqrt{xy} + y}{\sqrt{x} + \sqrt{y}} + \frac{1}{\sqrt{x} - \sqrt{y}}\right) \div \frac{x - y + 1}{\sqrt{x}}$ , 其中  $x = 2 - \sqrt{3}, y = 2 + \sqrt{3}$ .

---

### 26 (练习题)

**题目**: 26. 求  $\sqrt{2\sqrt{2\sqrt{2\sqrt{2\sqrt{2\sqrt{\cdots}}}}}} - \sqrt{2 + \sqrt{2 + \sqrt{2 + \sqrt{2 + \sqrt{2 + \sqrt{\cdots}}}}}$  的值.
...
**解答**: 分析 判断一个方程是否为一元二次方程，从三个方面着手：①判断方程是不是整式方程；②方程中是否只含有一个未知数；③未知数的最高次数是不是2. 解 (1) 整理得  $-x - 6 = 0$ , 这是一元一次方程, 不是一元二次方程. （2）由于这不是整式方程，因此它不是一元二次方程 （3）因为这是整式方程且只含一个未知数，未知数最高次数是2且二次项系数  $m^2 + 3 \neq 0$  ，所以该方程是一元二次方程. （4）该方程的分母中有未知数，它不是整式方程，因此不是一元二次方程 （5）该方程的未知数的最高次数为3，不是一元二次方程 (6) 当  $k = 1$  时, 该方程不是一元二次方程; 当  $k \neq 1$  时, 该方程是一元二次方程.
...
**题目**: (4)  $\frac{3}{4} x^2 -\sqrt{3} x + 1 = 0.$  （
...
**题目**: (6)  $kx^{2} - \sqrt{2} x = \frac{k + 2}{4} (k\neq 0).$  （

---

### 2(7) (练习题)

**题目**: (7)  $x^{2} - mx + \frac{1}{2} m^{2} + m + \frac{3}{2} = 0.$  （

---

### 2(8) (练习题)

**题目**: (8)  $(8k^{2} + 1)x^{2} - 4kx + 1 = 0.$  （
...
**题目**: (1)  $\frac{9}{2} x^2 + 2 = 6x$ ;

---

### 3(2) (练习题)

**题目**: (2)  $(8k^{2} + 1)x^{2} - 4kx + 1 = 0$ ;
...
**题目**: （1）若方程只有一个根，求  $k$  的值，并求此时方程的根；

---

### 6(2) (练习题)

**题目**: (2) 若方程有两个相等的实数根, 求  $k$  的值, 并求此时方程的根.
...
**题目**: 基础训练 1. 如图, 在  $\triangle ABC$  中,  $\angle ACB = 90^\circ$ ,  $CD \perp AB$  于点  $D$ , 写出图中相等的锐角:
...
**题目**: 基础训练 1. 如图, 已知: 在  $\triangle ABC$  中,  $BD \perp AC$  于点  $D$ ,  $CE \perp AB$  于点  $E$ , 且  $BD = CE$ . 求证：(1)  $\triangle EBC \cong \triangle DCB$ ；(2)  $DE \parallel BC$ .
